...
//039				
				} else if (c_alert[i].SOURCE_ID === "AL00134") {   //BMI Alert
					targetHTML.push("<span class='schn-alerts-cell'><a class='schn-link' href='javascript:APPLINK(100, \"http://www.healthnetworks.health.wa.gov.au/modelsofcare/docs/Morbid_Obesity_Model_of_Care.pdf\",\"\");' >" + c_alert[i].ANNOTATED + "</a></span>");
