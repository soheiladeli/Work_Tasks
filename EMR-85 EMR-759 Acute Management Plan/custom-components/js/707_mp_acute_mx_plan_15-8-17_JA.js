...
05/07/2017	Tony Fitzsimons		Add Asthma medication reducing plan
08/08/2017	Tony Fitzsimons		Add Anaesthetic management plan links
*************************************************************************/
...
var mxPlans = "";
			...
			if (jsonPlans){
				...
				if (plans_exist == 1){
					...
					if (jsonPlans.PLANS.AND_PLAN[0].AND_ACTIVITY_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:CCLLINK(\"707_AND_FORM_DATA\", \"^MINE^, "+MPAGE_REC.PERSON_ID+"\", 0);' title='Click link to view the plan'>" + jsonPlans.PLANS.AND_PLAN[0].AND_DESC + "</a></td><td>Last Updated: " + jsonPlans.PLANS.AND_PLAN[0].AND_UPDT + "<br />Updated by: " + jsonPlans.PLANS.AND_PLAN[0].AND_UPDT_BY + "</td></tr>");
					}
					
					//adrenal insufficiency management plan
					if (jsonPlans.PLANS.ADRENAL_INSUFF[0].ADR_ACTIVITY_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:CCLLINK(\"707_ADRENAL_PLAN\", \"^MINE^, "+MPAGE_REC.PERSON_ID+"\", 0);' title='Click link to view the plan'>" + jsonPlans.PLANS.ADRENAL_INSUFF[0].ADR_DESC + "</a></td><td>Last Updated:" + jsonPlans.PLANS.ADRENAL_INSUFF[0].ADR_UPDT + "<br />Updated by: " + jsonPlans.PLANS.ADRENAL_INSUFF[0].ADR_UPDT_BY + "</td></tr>");
					}
					
					//Anaesthetic Difficult Airway
					if (jsonPlans.PLANS.ANAES_AIRWAY[0].ANAW_EVENT_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:openDocumentViewer("+MPAGE_REC.PERSON_ID+", " + jsonPlans.PLANS.ANAES_AIRWAY[0].ANAW_EVENT_ID + ");' title='Click link to view the plan'>" + jsonPlans.PLANS.ANAES_AIRWAY[0].ANAW_DESC + "</a><td>Last Updated: " + jsonPlans.PLANS.ANAES_AIRWAY[0].ANAW_UPDT + "<br />Updated by: " + jsonPlans.PLANS.ANAES_AIRWAY[0].ANAW_UPDT_BY + "</td></tr>");
					}
					
					//Anaesthetic Special Needs
					if (jsonPlans.PLANS.ANAES_SPEC[0].ANSP_EVENT_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:openDocumentViewer("+MPAGE_REC.PERSON_ID+", " + jsonPlans.PLANS.ANAES_SPEC[0].ANSP_EVENT_ID + ");' title='Click link to view the plan'>" + jsonPlans.PLANS.ANAES_SPEC[0].ANSP_DESC + "</a><td>Last Updated: " + jsonPlans.PLANS.ANAES_SPEC[0].ANSP_UPDT + "<br />Updated by: " + jsonPlans.PLANS.ANAES_SPEC[0].ANSP_UPDT_BY + "</td></tr>");
					}
					
					//Intrathecal Baclofen plan
					if (jsonPlans.PLANS.ITB[0].ITB_EVENT_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:CCLLINK(\"707_REHAB_IBAC_PUMP\", \"^MINE^, "+MPAGE_REC.PERSON_ID+"\", 0);' title='Click link to view the plan'>" + jsonPlans.PLANS.ITB[0].ITB_DESC + "</a><br /><span class='schn-instruction'><a class='schn-link' href='javascript:APPLINK(100, \"http://webapps.schn.health.nsw.gov.au/epolicy/policy/2490\",\"\");'>ITB Practice Guidelines</a></span></td><td>Last Updated: " + jsonPlans.PLANS.ITB[0].ITB_UPDT + "<br />Updated by: " + jsonPlans.PLANS.ITB[0].ITB_UPDT_BY + "</td></tr>");
					}

					//Neuro Management Plan - ED
					if (jsonPlans.PLANS.NEURO_ED[0].NEURO_ED_EVENT_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:openDocumentViewer("+MPAGE_REC.PERSON_ID+", " + jsonPlans.PLANS.NEURO_ED[0].NEURO_ED_EVENT_ID + ");' title='Click link to view the plan'>" + jsonPlans.PLANS.NEURO_ED[0].NEURO_ED_DESC + "</a><td>Last Updated: " + jsonPlans.PLANS.NEURO_ED[0].NEURO_ED_UPDT + "<br />Updated by: " + jsonPlans.PLANS.NEURO_ED[0].NEURO_ED_UPDT_BY + "</td></tr>");
					}
					
					//Respiratory support settings
					if (jsonPlans.PLANS.RESP_SUPPORT[0].RESP_ACTIVITY_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:CCLLINK(\"707_RESPS_FORM_DATA\", \"^MINE^, "+MPAGE_REC.PERSON_ID+"\", 0);' title='Click link to view the plan'>" + jsonPlans.PLANS.RESP_SUPPORT[0].RESP_DESC + "</a></td><td>Last Updated:" + jsonPlans.PLANS.RESP_SUPPORT[0].RESP_UPDT + "<br />Updated by: " + jsonPlans.PLANS.RESP_SUPPORT[0].RESP_UPDT_BY + "</td></tr>");
					}
					
					//Seizure Management Plan - ED
					if (jsonPlans.PLANS.SEIZURE_ED[0].SEIZURE_ED_EVENT_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:openDocumentViewer("+MPAGE_REC.PERSON_ID+", " + jsonPlans.PLANS.SEIZURE_ED[0].SEIZURE_ED_EVENT_ID + ");' title='Click link to view the plan'>" + jsonPlans.PLANS.SEIZURE_ED[0].SEIZURE_ED_DESC + "</a><td>Last Updated: " + jsonPlans.PLANS.SEIZURE_ED[0].SEIZURE_ED_UPDT + "<br />Updated by: " + jsonPlans.PLANS.SEIZURE_ED[0].SEIZURE_ED_UPDT_BY + "</td></tr>");
					}

					//Seizure Management Plan - Inpatient
					if (jsonPlans.PLANS.SEIZURE_INPT[0].SEIZURE_INPT_EVENT_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:openDocumentViewer("+MPAGE_REC.PERSON_ID+", " + jsonPlans.PLANS.SEIZURE_INPT[0].SEIZURE_INPT_EVENT_ID + ");' title='Click link to view the plan'>" + jsonPlans.PLANS.SEIZURE_INPT[0].SEIZURE_INPT_DESC + "</a><td>Last Updated: " + jsonPlans.PLANS.SEIZURE_INPT[0].SEIZURE_INPT_UPDT + "<br />Updated by: " + jsonPlans.PLANS.SEIZURE_INPT[0].SEIZURE_INPT_UPDT_BY + "</td></tr>");
					}

					//severe asthma management plan
					if (jsonPlans.PLANS.SEV_AST_PLAN[0].SEV_ACTIVITY_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:CCLLINK(\"707_SEVERE_ASTHMA_DATA\", \"^MINE^, "+MPAGE_REC.PERSON_ID+"\", 0);' title='Click link to view the plan'>" + jsonPlans.PLANS.SEV_AST_PLAN[0].SEV_DESC + "</a></td><td>Last Updated:" + jsonPlans.PLANS.SEV_AST_PLAN[0].SEV_UPDT + "<br />Updated by: " + jsonPlans.PLANS.SEV_AST_PLAN[0].SEV_UPDT_BY + "</td></tr>");
					}
										
					/*
					//cvad
					if (jsonPlans.PLANS.CVAD[0].CVAD_ACTIVITY_ID > 0){
						targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:schn.openDocumentViewer("+MPAGE_REC.PERSON_ID+", " + jsonPlans.PLANS.CVAD[0].CVAD_EVENT_ID + ");' title='Click link to view latest document'>" + jsonPlans.PLANS.CVAD[0].CVAD_DESC + "</a></td><td>Last Updated:" + jsonPlans.PLANS.CVAD[0].CVAD_UPDT + "<br />Updated by: " + jsonPlans.PLANS.CVAD[0].CVAD_UPDT_BY + "</td></tr>");
					}
					*/
					...
					//	targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='#' >" + jsonPlans.PLANS.AST_ACT_PLAN[0].AST_DESC + "</a><br /><span class='schn-instruction'>Please go to Task Menu --> Reports to print the Asthma Action plan</span></td><td>Last Updated:" + jsonPlans.PLANS.AST_ACT_PLAN[0].AST_UPDT + "<br />Updated by: " + jsonPlans.PLANS.AST_ACT_PLAN[0].AST_UPDT_BY + "</td></tr>");
					    targetHTML.push("<tr class='amp_row'><td><a class='amp_link' href='javascript:CCLLINK(\"707_ASTHMA_ACTION_PLAN\", \"^MINE^, "+MPAGE_REC.PERSON_ID+"\", 0);' title='Click link to view the plan' >" + jsonPlans.PLANS.AST_ACT_PLAN[0].AST_DESC + "</a></td><td>Last Updated:" + jsonPlans.PLANS.AST_ACT_PLAN[0].AST_UPDT + "<br />Updated by: " + jsonPlans.PLANS.AST_ACT_PLAN[0].AST_UPDT_BY + "</td></tr>");
					}
	...
	mxPlans.open('GET', "707_MP_ACUTE_MANAGEMENT_PLAN");
