...
* 009 09/08/2017	Javad				Combine all management plans queriries to improve performance
*****************************************************************************************/
 
drop program 707_mp_acute_management_plan_1 go
create program 707_mp_acute_management_plan_1
...
PLAN c where c.person_id =  $person_ID
	and c.event_tag in ("Kids Rehab ITB Letter",
                     	...
                     	"Neurology Management Plan - ED",
                     	"Seizure Management Plan - ED",
                     	"Seizure Management Plan - Inpatient",
                     	"Anaesthetic Mgmt Plan - Difficult Airway",
                     	"Anaesthetic Mgmt Plan - Special Needs")
...
join prs where c.updt_id = prs.person_id
 
ORDER BY
	c.performed_dt_tm
 
head  c.performed_dt_tm
	d = 0
...
detail
	...
	elseif(c.event_tag in ("Kids GPS Management Plan")
	...
	elseif(c.event_tag in ( "Neurology Management Plan - ED")
     ...
     elseif(c.event_tag in ( "Seizure Management Plan - ED")
     ...
     elseif(c.event_tag in ( "Seizure Management Plan - Inpatient")
     ...
     elseif(c.event_tag in ( "Anaesthetic Mgmt Plan - Difficult Airway")
     ...
     elseif(c.event_tag in ( "Anaesthetic Mgmt Plan - Special Needs")
