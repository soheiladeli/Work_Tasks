...
;;001	17/08/2017 		Javad Adeli			Changed the default static content directory to
;;											"custome_mpage_content" if left empty in prefmaint
 ...
 IF ((trim ( $STATICCONTENTLOCATION ,3 ) = "" ) )
  SELECT INTO "nl:"
   ...
   DETAIL
    ...
    staticcontent = concat ("http://LB-Cerner-ODR/mpage-content/prod.schn.health.nsw.gov.au" ,"/custom_mpage_content/custom-components" )
    ;001<<
   WITH nocounter
  ;end select
 ELSE
