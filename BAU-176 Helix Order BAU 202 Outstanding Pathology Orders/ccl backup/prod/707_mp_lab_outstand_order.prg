...
* 004 24/05/16	   Tony Fitzsimons	  Add accession number
* 005 13/09/2017   Javad Adeli		  Add position code prompt and add logic to apply
...
;005<< Exclude Order Inquiry privilege exceptions
...
;004->
join a
where outerjoin(o.order_id) = a.order_id
;004<-
...
;001	orders->ord[cnt]->ord_name = uar_get_code_description(o.catalog_cd)
	orders->ord[cnt]->ord_name = oc.primary_mnemonic ;001
 	orders->ord[cnt]->acc_num = acc_nbr  ;004
