...
// 043 Andy Roberts			24/11/17	Add GS-US-313-1090 to schn.clintrials
// 044 Javad Adeli			29/11/2017	New developement and release of BTF Altered Calling Criteria (BTF ACC) custom MPage Component for Analytics MPage
// 045 Javad Adeli 			29/11/17	Enhanced the filters design and also the pop-up modal window in in complete discharge summeries componenet - dc_analytics
------------------------------------------------------------------------------------*/
...
schn.dc_analytics.prototype.addEventHandlers = function() {
	...
	//045>> $("#"+compId+" .dc-selector").change(function(event){
	$("#"+compId+" .schn-filters-selector").change(function(event){	//<<045
...
schn.dc_analytics.prototype.render = function() {
	...
	//045>> targetHTML.push('<form><fieldset>',
	targetHTML.push('<div class="schn-filters-form"><form><fieldset>', //<<045
						'<div class="selection">',
						'<label for="schn-dc-lookback">Lookback Range: </label>',
						//045>> '<select name="lookback" id="schn-dc-lookback" size="1" class="dc-selector">',
						'<select name="lookback" id="schn-dc-lookback" size="1" class="schn-filters-selector">', //<<045
						...
						//045>> '<select name="facility" id="schn-dc-facility" size="1" class="dc-selector">',
						'<select name="facility" id="schn-dc-facility" size="1" class="schn-filters-selector">', //<<045
							'<option value="CHW" selected="selected">CHW</option>',
						'</select>',
						'</div>',
						'<div class="selection">',
						'<label for="schn-dc-wards">Ward: </label>',
						//045>> '<select name="wards" id="schn-dc-wards" size="1" class="dc-selector">',
						'<select name="wards" id="schn-dc-wards" size="1" class="schn-filters-selector">', //<<045
	...
	targetHTML.push('<div class="selection">',
						...
						//045>> '<select name="medserv" id="schn-dc-medserv" class="dc-selector">',
						'<select name="medserv" id="schn-dc-medserv" class="schn-filters-selector">', //<<045
	...
	targetHTML.push('<div class="selection">',
						...
						//045>> '<select name="amo" id="schn-dc-amo" class="dc-selector">',
						'<select name="amo" id="schn-dc-amo" class="schn-filters-selector">', //<<045
							'<option value="All">All</option>');
	...
	//045>> targetHTML.push('</fieldset></form>');
	targetHTML.push('</fieldset></form></div></section></div>'); //<<045
	targetHTML.push('<div id="dc-hover"></div>');
	//pie chart display
	//045>> targetHTML.push('<div id="dc-chart" class="dc-pie-chart" style="width:100%;height:250px"></div>');
	targetHTML.push('<div id="dc-chart" class="dc-pie-chart" style="width:100%;height:200px; margin-top:7px; margin-bottom:10px;"></div>'); //<<045
	
	//modal pop up window for on-click event
	targetHTML.push('<div id="schn-dc-modal" class="schn-modal">',
						//045>> '<div id="schn-dc-modal-content" class="schn-modal-content"><span class="schn-close">X</span>',
						'<div id="schn-dc-modal-content" class="schn-modal-content"><span class="schn-close"style="margin-bottom:10px";>&#10006;</span>', //<<045
							'<div id="dc-list">',
							'</div>',
						'</div>',
					'</div>');
...
schn.clintrials.prototype.render = function() {
	...
	var GSUS3131090_link = "gs-us-313-1090.pdf"; //043
