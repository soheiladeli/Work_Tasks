...
// 046 Javad Adeli 			29/11/17	Enhanced the filters design and also the pop-up modal window in in complete discharge summeries componenet - dc_analytics 
------------------------------------------------------------------------------------*/
...
schn.dc_analytics.prototype.render = function() {
	...
	//046>> targetHTML.push('<form><fieldset>',
	targetHTML.push('<div class="schn-filters-form"><form><fieldset>', //<<046
						'<div class="selection">',
						'<label for="schn-dc-lookback">Lookback Range: </label>',
						//046>> '<select name="lookback" id="schn-dc-lookback" size="1" class="dc-selector">',
						'<select name="lookback" id="schn-dc-lookback" size="1" class="schn-filters-selector">', //<<046
						...
						//046>> '<select name="facility" id="schn-dc-facility" size="1" class="dc-selector">',
						'<select name="facility" id="schn-dc-facility" size="1" class="schn-filters-selector">', //<<046
							'<option value="CHW" selected="selected">CHW</option>',
						'</select>',
						'</div>',
						'<div class="selection">',
						'<label for="schn-dc-wards">Ward: </label>',
						//046>> '<select name="wards" id="schn-dc-wards" size="1" class="dc-selector">',
						'<select name="wards" id="schn-dc-wards" size="1" class="schn-filters-selector">', //<<046
	...
	targetHTML.push('<div class="selection">',
						...
						//046>> '<select name="medserv" id="schn-dc-medserv" class="dc-selector">',
						'<select name="medserv" id="schn-dc-medserv" class="schn-filters-selector">', //<<046
	...
	targetHTML.push('<div class="selection">',
						...
						//046>> '<select name="amo" id="schn-dc-amo" class="dc-selector">',
						'<select name="amo" id="schn-dc-amo" class="schn-filters-selector">', //<<046
							'<option value="All">All</option>');
	...
	//046>> targetHTML.push('</fieldset></form>');
	targetHTML.push('</fieldset></form></div></section></div>'); //<<046
	targetHTML.push('<div id="dc-hover"></div>');
	//pie chart display
	//046>> targetHTML.push('<div id="dc-chart" class="dc-pie-chart" style="width:100%;height:250px"></div>');
	targetHTML.push('<div id="dc-chart" class="dc-pie-chart" style="width:100%;height:200px; margin-top:7px; margin-bottom:10px;"></div>'); //<<046
	
	//modal pop up window for on-click event
	targetHTML.push('<div id="schn-dc-modal" class="schn-modal">',
						//046>> '<div id="schn-dc-modal-content" class="schn-modal-content"><span class="schn-close">X</span>',
						'<div id="schn-dc-modal-content" class="schn-modal-content"><span class="schn-close"style="margin-bottom:10px";>&#10006;</span>', //<<046
							'<div id="dc-list">',
							'</div>',
						'</div>',
					'</div>');
...
044>> SCHN BTF Altered Caling Criteria (ACC)
...
schn.btf_acc.prototype.render = function() {
	...
	targetHTML.push('<label for="show_filters-acc" onclick=""><span>Change BTF ACC Filters &#9776;&#9662;</span><span style="font-weight: bold;">&#10005;</span></label>');
	targetHTML.push('<section>');
	//JAVADELI<<
...
schn.btf_acc.prototype.updateFilters = function() {
	...
	if (filterRange.length == 0) {
        $("#acc-chart").html("No results for ward: <span class='boldie'>" + wardLook + "</span>, Encounter Type: <span class='boldie'>" + encntrtypeLook 
