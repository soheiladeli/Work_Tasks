 ...
 *--- 	--------   -------------------- ---------------------------------			*
 *000	1/11/17		Javad Adeli			To audit the list of all documents charted  *
 *										that need to be hidden and then update the 	*
...
;listing the updated documents only
select into $outdev
	c.person_id
	, patient_name = p.name_full_formatted
	, c.clinical_event_id
